...
public class ModernKeycloakController {

    @GetMapping("/baeldung/.well-known/openid_configuration")
    public ResponseEntity<String> openidConfiguration() {
        String config = """
            {
              "issuer": "http://localhost:8083/realms/baeldung",
              "authorization_endpoint": "http://localhost:8083/realms/baeldung/protocol/openid-connect/auth",
              "token_endpoint": "http://localhost:8083/realms/baeldung/protocol/openid-connect/token",
              "userinfo_endpoint": "http://localhost:8083/realms/baeldung/protocol/openid-connect/userinfo",
              "end_session_endpoint": "http://localhost:8083/realms/baeldung/protocol/openid-connect/logout",
              "jwks_uri": "http://localhost:8083/realms/baeldung/protocol/openid-connect/certs",
    ...
    @GetMapping("/baeldung/protocol/openid-connect/certs")
    ...
    @GetMapping("/baeldung/protocol/openid-connect/auth")
    public ResponseEntity<String> auth() {
        ...
        String loginForm = """
            ...
            <body>
            <h2>Login</h2>
            <form method="post" action="http://localhost:8083/realms/baeldung/protocol/openid-connect/auth-login">
    ...
    @PostMapping("/baeldung/protocol/openid-connect/auth-login")
    ...
    @PostMapping("/baeldung/protocol/openid-connect/token")
