...
public class LhjApp {
    ...
    public static void main(final String... args) {
        try {
            ...
            campaignRepository.createCampaignWithTasksSimplified(campaign1, List.of(task1, task2));
            ...
            try {
                campaignRepository.createCampaignWithTasksSimplified(campaign2, List.of(taskWithNoName));
