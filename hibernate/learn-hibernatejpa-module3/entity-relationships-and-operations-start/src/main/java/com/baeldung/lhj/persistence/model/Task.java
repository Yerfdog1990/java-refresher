...
public class Task {
    ...
    @JoinColumn(name = "campaign_id") //-> We won’t perform this change, but if we wanted to switch ownership to the parent (Campaign), we could add a @JoinColumn to the parent’s side:
