...
import springsecurity.lesson1springsecuritywithjsp.persistance.repository.IStudentRepository;
...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson1springsecuritywithjsp.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson1springsecuritywithjsp.persistance.model.Authority authority = new springsecurity.lesson1springsecuritywithjsp.persistance.model.Authority(student, "ROLE_USER");
