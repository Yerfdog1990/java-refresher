...
import springsecurity.lesson3trackingloggedinusers.persistance.model.Authority;
...
import springsecurity.lesson3trackingloggedinusers.persistance.repository.VerificationTokenRepository;
...
public class StudentService implements IStudentService {
    ...
    public Optional<StudentDTO> findById(Long id) {
        return repository.findById(id).map(StudentDTO::fromEntity);
    }
