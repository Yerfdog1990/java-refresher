...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson6ensurepasswordstrength.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson6ensurepasswordstrength.persistance.model.Authority authority = new springsecurity.lesson6ensurepasswordstrength.persistance.model.Authority(student, "ROLE_USER");
