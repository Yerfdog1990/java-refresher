...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson4forgotpassword.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson4forgotpassword.persistance.model.Authority authority = new springsecurity.lesson4forgotpassword.persistance.model.Authority(student, "ROLE_USER");
