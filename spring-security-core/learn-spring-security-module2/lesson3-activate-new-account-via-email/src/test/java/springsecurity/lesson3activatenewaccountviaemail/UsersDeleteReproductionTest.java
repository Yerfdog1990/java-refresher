...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson3activatenewaccountviaemail.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson3activatenewaccountviaemail.persistance.model.Authority authority = new springsecurity.lesson3activatenewaccountviaemail.persistance.model.Authority(student, "ROLE_USER");
