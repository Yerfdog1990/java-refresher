package springsecurity.lesson3activatenewaccountviaemail.configuration;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/signup", "/student/register", "/registrationConfirm", "/activation", "/authenticated", "/css/**", "/js/**").permitAll()
