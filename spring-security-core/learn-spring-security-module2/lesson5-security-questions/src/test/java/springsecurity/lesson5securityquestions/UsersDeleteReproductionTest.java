...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson5securityquestions.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson5securityquestions.persistance.model.Authority authority = new springsecurity.lesson5securityquestions.persistance.model.Authority(student, "ROLE_USER");
