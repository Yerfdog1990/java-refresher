...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson3remembermewithpersistence.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson3remembermewithpersistence.persistance.model.Authority authority = new springsecurity.lesson3remembermewithpersistence.persistance.model.Authority(student, "ROLE_USER");
