...
public class UsersDeleteReproductionTest {
    ...
    @Autowired
    private springsecurity.lesson1rememberme.persistance.service.IStudentService studentService;
    ...
    public void givenExistingUserWithTokenAndAuthority_whenDeleteRequest_thenShouldRedirectToUsersList() throws Exception {
        ...
        springsecurity.lesson1rememberme.persistance.model.Authority authority = new springsecurity.lesson1rememberme.persistance.model.Authority(student, "ROLE_USER");
