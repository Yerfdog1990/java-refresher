...
- Enter the API information you got from Twilio into application.yaml
...
- To register first, Make a POST request at "/myUser/register" like a
...
- To normal login, Make a POST request at  "/myUser" like a
...
<br>
- To OTP login, Make a POST request at "/myUser/secret" like a
