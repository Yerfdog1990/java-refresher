package springsecurity.lesson1topologyofrolesandprivileges.controller;
...
import springsecurity.lesson1topologyofrolesandprivileges.persistance.model.*;
import springsecurity.lesson1topologyofrolesandprivileges.persistance.repository.SecurityQuestionDefinitionRepository;
import springsecurity.lesson1topologyofrolesandprivileges.persistance.repository.SecurityQuestionRepository;
import springsecurity.lesson1topologyofrolesandprivileges.persistance.service.IStudentService;
import springsecurity.lesson1topologyofrolesandprivileges.registration.OnRegistrationCompleteEvent;
        ...
        try {
            ...
            if (roleNames != null) {
                ...
                for (String auth : roleNames) {
                    student.getRoles().add(new Role(auth));
                }
            }
