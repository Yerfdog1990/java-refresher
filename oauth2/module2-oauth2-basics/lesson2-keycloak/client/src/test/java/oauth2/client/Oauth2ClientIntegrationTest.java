...
public class Oauth2ClientIntegrationTest {
    ...
    private final String CLIENT_BASE_URL = "";
    ...
    public void beforeEach() throws Exception {
        if (webTestClient == null) {
            webTestClient = WebTestClient.bindToServer().baseUrl("http://localhost:" + port + "/lsso-client").build();
        }
    ...
    public void givenAuthServerAndResourceServer_whenPerformClientLoginProcess_thenProcessExecutesOk() throws Exception {
        ...
        ExchangeResult result = this.webTestClient.get()
            ...
            .isFound()
            .expectHeader()
            .location("http://localhost:" + port + "/lsso-client/oauth2/authorization/custom")
            .returnResult(Void.class);

        // redirects to 'custom' OAuth authorization endpoint
        String cookieSession = Objects.requireNonNull(result.getResponseCookies()
                        .getFirst("JSESSIONID"))
            .getValue();
        ...
        result = this.webTestClient.get()
            ...
            .isFound()
            .expectHeader()
            .value(HttpHeaders.LOCATION, loc -> assertThat(loc).startsWith(authServerAuthorizationURL))
            .returnResult(Void.class);
        ...
        String code = "123";
        String REDIRECT_URI = "/login/oauth2/code/custom?state=%s&code=%s";
        result = this.webTestClient.get()
            ...
            .isFound()
            .expectHeader()
            .location("http://localhost:" + port + "/lsso-client" + CLIENT_SECURED_URL)
            .returnResult(Void.class);
        ...
        String newCookieSession = Objects.requireNonNull(result.getResponseCookies()
                        .getFirst("JSESSIONID"))
            .getValue();
        ...
        this.webTestClient.get()
            ...
            .consumeWith(response -> {
                String bodyAsString = new String(Objects.requireNonNull(response.getResponseBodyContent()));
