...
import com.baeldung.lmock.service.defaultimpl.DefaultReportsService;
import com.baeldung.lmock.service.defaultimpl.DefaultTaskService;
import com.baeldung.lmock.service.defaultimpl.DefaultWorkerService;
import com.baeldung.lmock.service.reports.DetailedMapReportBuilder;
import com.baeldung.lmock.service.reports.SimpleMapReportBuilder;

public class LmockApp {

    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger(LmockApp.class);
        logger.info("Running Learn Mockito App");
