...
class JacksonUnitTest {
    ...
    @Test
    void givenEnableFeatureToggle_whenSerializingAnObject_thenBehaviorIsAdjusted() throws JsonProcessingException {
    ...
    @Test
    void givenDisableFeatureToggle_whenSerializingAnObject_thenBehaviorIsAdjusted() throws JsonProcessingException {
        class EmptyClass {
        }
    ...
    //  Feature Toggles -> configure()
    @Test
    void givenConfigureFeatureToggle_whenSerializingAnObject_thenBehaviorIsAdjusted() throws JsonProcessingException {
        String json = """
        {
        "code":"X1",
        "name":"Extra",
