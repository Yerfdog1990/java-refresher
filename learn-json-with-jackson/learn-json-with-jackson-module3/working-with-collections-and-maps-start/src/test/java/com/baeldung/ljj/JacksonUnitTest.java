...
class JacksonUnitTest {
    ...
    @Test
    // Deserializing JSON Into a List
    void givenJsonTaskArray_whenDeserializingToListOfTasks_thenCorrect() throws Exception {
        ...
        assertInstanceOf(ArrayList.class, tasks);
    ...
    void givenJsonTaskArray_whenDeserializingToSet_thenOk() throws Exception {
        ...
        assertInstanceOf(HashSet.class, tasks);
        assertEquals(2, tasks.size());
    ...
    void givenJson_whenDeserializingToMap_thenKeysAndValuesAreRestored() throws Exception {
        ...
        assertInstanceOf(LinkedHashMap.class, tasks);
    ...
    @Test
    // Serialize a Map where each key maps to a List of Task objects
    ...
    @Test
    // Deserialize the JSON structure back into the original Java type
