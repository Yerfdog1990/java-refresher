...
public class DataSortingApp implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Sort sortByDueDateAssigneLastName = Sort.by(Sort.Direction.DESC, "dueDate")
                .and(Sort.by(Sort.Direction.ASC, "assignee.lastName"));
        ...
        Sort.TypedSort<Task> taskTypedSort = Sort.sort(Task.class);
