...
public class ContractTaskApiIntegrationTest {
    ...
    @Test
    void givenPreloadedData_whenCreateNewTask_withValidTaskJsonString_thenSuccess() throws Exception {
        ...
        webClient.post()
                ...
                .expectBody()
                .jsonPath("$.id").exists()
                .jsonPath("$.name").isEqualTo("Test - New Task 1")
                .jsonPath("$.campaignId").value(greaterThan(0))
                .jsonPath("$.dueDate").isEqualTo("2050-12-30");
    }
    ...
    void createNewTask_withValidTaskJsonFromFile_thenSuccess() throws Exception {
        ...
        webClient.post()
                ...
                .expectBody()
                .jsonPath("$.id").exists()
                .jsonPath("$.name").isEqualTo("Test - New Task 2")
                .jsonPath("$.campaignId").value(greaterThan(0))
                .jsonPath("$.dueDate").isEqualTo("2050-12-30");
        // …
    }
